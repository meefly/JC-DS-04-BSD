...
def class_registration():
    class_list = {1: 'Data Science Class', 2: 'Web and Mobile Class', 3: 'Digital Marketing', 4: 'UI/UX Class'}
        ...
        if pilih == 1:
            ...
            if current_user == '':
                ...
                if len(history[current_user]) > 1:
                    ...
                    for i, j in zip(history[current_user], range(len(history[current_user]))):
                        if j < len(history[current_user])-1:
                            z += ' {},'.format(i)
                        else:
                            z+= ' and {}'.format(i)
                    print(z)            
